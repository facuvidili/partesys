...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'tasks' => [
            'required' => 'Debe ingresar por lo menos una tarea'
        ],
        'total' => [
            'required' => 'Debe calcular el total para poder seguir'
        ],
        'taskDescription' => [
            'not_in' => 'La tarea seleccionada ya se encuentra agregada'
        ],
        'totalTasksHrs' => [
            'in' => 'La duración de las tareas agregadas debe corresponder con el total de horas'
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'name' => 'nombre',
        'budget' => 'presupuesto',
        'is_deficitary' => 'deficitaria',
        'exConceptId' => 'concepto extraordinario',
        'exConceptValue' => 'valor del concepto',
        'crew_id' => 'n° cuadrilla',
